...
connect_wifi("IQOO Neo 6", "x31415926y")  # Connect to WiFi

client = MQTTClient("openmv", "broker.emqx.io", port=1883)
client.connect()
...
servo = Servo360(0x40400000, 8) # PROT0, P008
led = LED("LED_BLUE")
clock = time.clock()
RPS = {
    0: "rock",
        ...
        if predictions_max > 0.90:
            ...
            if machines_gesture == 0: # rock
                ...
                if predictions_num == "rock":
                    ...
                    compare_result = "draw"
            client.publish("openmv/test", ujson.dumps({"compare_times": compare_times,
                                                       "machine_label":RPS[machines_gesture],
